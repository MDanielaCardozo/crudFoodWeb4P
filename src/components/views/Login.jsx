              ...
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <Form.Control
                    ...
                    {...register("password", {
                      required: "La contrasenia es un dato obligatorio",
                      pattern: {
                        value: /^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$/,
                        message:
                        "La contrasenia debe tener entre 8 y 16 caracteres, al menos un digito, al menos una minuscula, al menos una mayuscula y al menos un caracter especial"
                      }
                    })}
